...
\begin{figure}[H]
 \centering
 \includegraphics[scale=.44]{./images/graph_build.png}
...
\end{figure}
 ...
 \begin{figure}[H]
  \centering
  \includegraphics[scale=0.44]{./images/graph_build_1.png}
...
l'exploration de ce côte de l'arbre s'arrête et passe à l'autre côté.
 ...
 \begin{figure}[H]
  \centering
  \includegraphics[scale=0.44]{./images/graph_build_2.png}
...
l'exploration.
 ...
 \begin{figure}[H]
  \centering
  \includegraphics[scale=0.44]{./images/graph_build_3.png}
  \caption{Étape 3 : Exploration de l'arbre (profondeur 2)}
 \end{figure}

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.44]{./images/graph_build_4.png}
