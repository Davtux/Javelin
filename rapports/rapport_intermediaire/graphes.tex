...
\section{Différents format de représentation}
  ...
  \begin{longtable}{|c|p{2cm}|p{2cm}|p{8cm}|}
    ...
    \textbf{Dracula \footnote{Dracula : https://www.graphdracula.net/}} & JavaScript & MIT & Dracula est une bibliothèque très simple à utiliser par les utilisateurs, des options de drag-and-drop y sont présentes. Côté développeur, les fonctions d'ajout de n\oeu{}ds et de gestion globales des graphes ont été implantées ainsi que certains algorithmes commums (Dijkstra, divers parcours...)\\
    \hline
